...
/**
 * Determines if a word is an indefinite article (code 'I') according to the Moby Parts of Speech dataset
 ...
 * @returns True if the word is an indefinite article, otherwise false.
 *
 * @example
 * isIndefiniteArticle('a'); // true
 * isIndefiniteArticle('the'); // false
 *
